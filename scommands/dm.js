...
export default {
    ...
    data: new SlashCommandBuilder()
        ...
        .addUserOption((option) =>
            option.setName("user").setDescription("Nutzer, an den die Nachricht gesendet werden soll").setRequired(true).setDescriptionLocalizations({
        ...
        .addStringOption((option) =>
            option.setName("content").setDescription("Inhalt der Nachricht").setRequired(true).setDescriptionLocalizations({
