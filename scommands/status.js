    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                ...
                .addChoices(
                    ...
                    {
                        name: localization.presence.choices.Invisible.en,
                        name_localizations: { de: localization.presence.choices.Invisible.de },
                        value: "invisible",
                    },
                    {
                        name: localization.presence.choices.Streaming.en,
                        name_localizations: { de: localization.presence.choices.Streaming.de },
                        value: "streaming",
                    }
                )
        )
        ...
        .addStringOption((option) =>
            option
                ...
                .addChoices(
                    {
                        name: localization.activity.choices.Competing.en,
                        name_localizations: { de: localization.activity.choices.Competing.de },
                        value: "Competing",
                    },
                    {
                        name: localization.activity.choices.Listening.en,
                        name_localizations: { de: localization.activity.choices.Listening.de },
                        value: "Listening",
                    },
                    ...
                    {
                        name: localization.activity.choices.Watching.en,
                        name_localizations: { de: localization.activity.choices.Watching.de },
                        value: "Watching",
                    }
                )
        ),
