    ...
    client.on('messageReactionAdd', async(reaction, user) => {
        ...
        try {
            ...
            if (reaction.emoji.id === '800645521277452298') {
                ...
                client.channels.cache.get(botlog).send('<@' + user.id + '> hat nun die BotNews <:BotNews:800645521277452298> Rolle bekommen. \n Seine ID: `' + user.id + '`, `' + user.createdAt.toLocaleString() + '`')
                return
            }
            ...
            if (reaction.emoji.id === '800643239241711638') {
                ...
                client.channels.cache.get(botlog).send('<@' + user.id + '> hat nun die News <:News:800643239241711638> Rolle bekommen. \n Seine ID: `' + user.id + '`, `' + user.createdAt.toLocaleString() + '`')
                return
            }

            if (reaction.emoji.id === '844909801297018891') {
                userObj.roles.add(mcRole)
                client.channels.cache.get(botlog).send('<@' + user.id + '> hat nun die Minecraft <:Minecraft:844909801297018891> Rolle bekommen. \n Seine ID: `' + user.id + '`, `' + user.createdAt.toLocaleString() + '`')
            }
        } catch (error) {
    ...
    client.on('messageReactionRemove', async(reaction, user) => {
        ...
        try {
            ...
            if (reaction.emoji.id === '800645521277452298') {
                ...
                client.channels.cache.get(botlog).send('<@' + user.id + '> hat nun die BotNews <:BotNews:800645521277452298> Rolle entfernt bekommen. \n Seine ID: `' + user.id + '`, `' + user.createdAt.toLocaleString() + '`')
                return
            }
            ...
            if (reaction.emoji.id === '800643239241711638') {
                ...
                client.channels.cache.get(botlog).send('<@' + user.id + '> hat nun die News <:News:800643239241711638> Rolle entfernt bekommen. \n Seine ID: `' + user.id + '`, `' + user.createdAt.toLocaleString() + '`')
                return
            }

            if (reaction.emoji.id === '844909801297018891') {
                userObj.roles.remove(mcRole)
                client.channels.cache.get(botlog).send('<@' + user.id + '> hat nun die Minecraft <:Minecraft:844909801297018891> Rolle entfernt bekommen. \n Seine ID: `' + user.id + '`, `' + user.createdAt.toLocaleString() + '`')
            }
        } catch (error) {
            const embedFail2 = new Discord.MessageEmbed()
                ...
                .setTimestamp()
                .setColor('fc036b')
            client.channels.cache.get(botlog).send({ embeds: [embedFail2] })
        }
