    ...
    .then(async (msg) => {
      ...
      collector.on("collect", async (i) => {
        ...
        const embed = new EmbedBuilder()
          ...
          .setTimestamp(now);
        if (y == 1)
          embed.setImage("https://sonneberg.allsky7.net/latest/010319.jpg");
        if (y >= 2)
          embed.setImage("https://sonneberg.allsky7.net/latest/010320.jpg");
        if (y <= 0 && x <= 0)
          embed.setImage("https://sonneberg.allsky7.net/latest/010314.jpg");
        if (y <= 0 && x == 1)
          embed.setImage("https://sonneberg.allsky7.net/latest/010315.jpg");
        if (y <= 0 && x == 2)
          embed.setImage("https://sonneberg.allsky7.net/latest/010316.jpg");
        if (y <= 0 && x == 3)
          embed.setImage("https://sonneberg.allsky7.net/latest/010317.jpg");
        if (y <= 0 && x >= 4)
          embed.setImage("https://sonneberg.allsky7.net/latest/010318.jpg");
      ...
      collector.on("end", async () => {
        if (msg.editable) {
          ...
          const disabledRowMiddle = new ActionRowBuilder().addComponents(
            buttonListMiddle
          );
          const disabledRowDown = new ActionRowBuilder().addComponents(
            buttonListDown
          );
