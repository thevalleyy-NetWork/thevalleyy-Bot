...
module.exports = async (client, interaction) => {
    ...
    try {
        ...
        const { title, author, lyrics, thumbnail, links, error } = await fetch(`https://some-random-api.ml/lyrics?title=${arguments.replaceAll('ä', 'ae').replaceAll('ü', 'ue').replaceAll('ö', 'oe').replaceAll('ß', 'ss')}`).then(response => response.json())
